...
$$ 
\pi(\Bbb{R}) = \{(-\infty, c] : c \in \Bbb{R} \} 
$$ 

is a $\pi$-system which generates $\mathcal{B}$, Uniqueness Lemma 1.6 shows that $\mathcal{L}_{X}$ is determined by the function $ F_{X} : \Bbb{R} \rightarrow [0, 1] $ defined as follows:
